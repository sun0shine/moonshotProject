...
for page in range(1, 5):
    ...
    link = "http://search.joins.com/JoongangNews?Keyword=%ED%8F%AC%EC%8A%A4%EC%BD%94&SortType=New&SearchCategoryType=JoongangNews&MatchKeyword=%ED%8F%AC%EC%8A%A4%EC%BD%94&PeriodType=All&ScopeType=All&ImageType=All&JplusType=All&BlogType=All&ImageSearchType=Image&TotalCount=0&StartCount=0&IsChosung=False&IssueCategoryType=All&IsDuplicate=True&Page=" + str(page) + "&PageSize=10&IsNeedTotalCount=True"
    ...
    test = soup.find_all("ul", class_="list_default")
    ...
    for each in test:
        ...
        lst = each.find_all('strong', class_='headline mg')
...
f = open("JoongAng_Daily.txt","w", encoding="utf-8")

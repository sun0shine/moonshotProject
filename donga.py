...
for page in range(1, 3):
    ...
    link = "http://news.donga.com/search?p=1&query=%ED%8F%AC%EC%8A%A4%EC%BD%94&check_news=2&more=1&sorting=3&search_date=1&v1=&v2=&range=" + str(page)
    ...
    test = soup.find_all("div", class_="searchCont")
    ...
    for each in test:
        ...
        lst = each.find_all('p', class_='tit')
...
f = open("donga.txt","w", encoding="utf-8")

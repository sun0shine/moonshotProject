...
for page in range(1, 10):
    ...
    link = "http://biz.heraldcorp.com/search/?q=%ED%8F%AC%EC%8A%A4%EC%BD%94&dt=1&nt=1&np=" + str(page)
    ...
    test = soup.find_all("dl", class_="search_newslist")
    ...
    for each in test:
        ...
        lst = each.find_all('p', class_="ntitle")
...
f = open("herald.txt","w", encoding="utf-8")

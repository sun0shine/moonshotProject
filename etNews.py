...
for page in range(1, 3):
    ...
    link = "http://search.etnews.com/etnews/search.php?category=CATEGORY1&kwd=%ED%8F%AC%EC%8A%A4%EC%BD%94&pageNum=" + str(page)
    ...
    test = soup.find_all("ul", class_="list_news")
...
f = open("etNews.txt","w", encoding="utf-8")

...
for page in range(1, 3):
    ...
    link = "http://search.mt.co.kr/searchNewsList.html?srchFd=TOTAL&range=TOTAL&reSrchFlag=&preKwd=&search_type=m&kwd=%B8%D3%B4%CF%C5%F5%B5%A5%C0%CC&bgndt=&enddt=&category=MTNW&sortType=allwordsyn&subYear=&category=MTNW&subType=mt&pageNum=" + str(page)
    ...
    test = soup.find_all("div", class_="section")
    ...
    for each in test:
        ...
        lst = each.find_all('strong', class_='subject')
...
f = open("Money_today.txt","w", encoding="utf-8")

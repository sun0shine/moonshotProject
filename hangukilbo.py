...
for page in range(1, 5):
    ...
    link = "http://search.hankookilbo.com/?stype=&scate=&sdate=&sctype=0&page=" + str(page)
    ...
    test = soup.find_all("div", class_="dw_news")
    ...
    for each in test:
        ...
        lst = each.find_all('dt', class_="hankook_news-title")
...
f = open("Hangukilbo.txt","w", encoding="utf-8")
